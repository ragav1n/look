...
export default function Help() {
  return (
    <div>
      <h1 className="font-display text-[26px] font-medium text-white">Help & Support</h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <a href={site.emailHref} className="rounded-card border border-line p-5 transition-colors hover:border-accent">
          ...
          <p className="mt-1 text-[15px] font-medium text-white">{site.email}</p>
        </a>
        <a href={site.phoneHref} className="rounded-card border border-line p-5 transition-colors hover:border-accent">
          ...
          <p className="mt-1 text-[15px] font-medium text-white">{site.phone}</p>
        </a>
        <a
          href={site.instagram}
          target="_blank"
        ...
        >
          ...
          <p className="mt-1 text-[15px] font-medium text-white">{site.instagramHandle}</p>
        </a>
        <Link to="/support" className="rounded-card border border-line p-5 transition-colors hover:border-accent">
          ...
          <p className="mt-1 text-[15px] font-medium text-white">FAQs & support →</p>
        </Link>
      </div>
    </div>
  );

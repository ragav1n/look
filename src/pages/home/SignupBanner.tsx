  ...
  return (
    <section className="py-[80px]" aria-labelledby="signup-heading">
      <div className="mx-auto w-full max-w-[1338px] px-6 min-[1400px]:px-0">
        <div className="rounded-card bg-accent px-8 py-[56px] text-center text-white lg:px-16">
          ...
          {done ? (
            ...
            >
              ...
              <button
                type="submit"
                className="h-[50px] shrink-0 cursor-pointer rounded-btn bg-black px-7 text-[15px] font-medium text-white transition-opacity hover:opacity-85"
              >
                Subscribe
              </button>
            </form>
